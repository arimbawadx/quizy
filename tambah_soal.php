...
<body>
	<div class="body">
			<div class="judul"><h1>Tambah Soal</h1></div>
		<br>
		<form method="post" action=""> 
			<div align="left">
					<label for="nama_quiz">Nama Quiz</label>
					<br>
					<input type="text" id="nama_quiz" autocomplete="off" name="nama_quiz" readonly value="<?php echo $nama_quiz ?>">
